...
export const parseJS = untilEnd(
    or(
        consume(funcCallName, "FUNC_CALL"),
        consume(comment, "COMMENT"),
        consume(string, "STRING"),
        consume(number, "NUMBER"),
        consume(keyword("function"), "KEYWORD"),
        consume(keyword("const"), "KEYWORD_CONST"),
        consume(keyword("export"), "KEYWORD"),
        consume(keyword("class"), "KEYWORD"),
        consume(keyword("return"), "KEYWORD"),
